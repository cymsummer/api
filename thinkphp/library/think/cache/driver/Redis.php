...
=======
        'host' => '39.106.20.103',
>>>>>>> cac66155b17cc1b02df19c86cef1d16586344151
        'port' => 6379,
        'password' => '',
        'select' => 0,
        'timeout' => 0,
    ...
    public function zAdd($key, $score1, $value)
    {
        var_dump($score1);
        var_dump($value);
        $this->handler->zAdd($key, $score1, $value);
    }
    /*
    * zRevRange
    * */
    ...
    {
        return $this->handler->zRange($key, $start, $stop,true);
    }
    /*
     * zcard
     * */
    ...
    public function hMset($key,$hashKey){
        $this->handler->hMset($key,$hashKey);
    }
    public function lPush($key,$hashKey){
        $this->handler->lPush($key,$hashKey);
    }
    /*
     * hGetAll
     * */
